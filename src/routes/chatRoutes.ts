...
chatRoutes.post('/create-new-group-chat',userAuthentication,chatControllers.createGroupChat)
...
chatRoutes.put("/update-info",userAuthentication,chatControllers.updateProfileInfo)
